...
f = x + [(u(1) + u(2))/2 * cos(x(3) + (u(2) - u(1))/(2*b))
        ...
        (u(2) - u(1))/b];
F_x = [1, 0, -(u(1) + u(2))/2 * sin(x(3) + (u(2) - u(1))/(2*b))
       0, 1, (u(1) + u(2))/2 * cos(x(3) + (u(2) - u(1))/(2*b))
       0, 0, 1];
F_u = [ 0.5*cos(x(3) + (u(2) - u(1))/(2*b)) + sin(x(3) + (u(2) - u(1))/(2*b))*0.5*(u(1) + u(2))/(2*b), 0.5*cos(x(3) + (u(2) - u(1))/(2*b)) - sin(x(3) + (u(2) - u(1))/(2*b))*0.5*(u(1) + u(2))/(2*b)
